...
metadata_path = "/Users/runbojiang/Desktop/LinkML_NMR/my-nmr-metadata.csv"
...
def ingest(
    ...
    print(file_path)
    dataset_id = scicat_client.upload_raw_dataset(dataset) #upload_raw_dataset
    data_file = DataFile(path=str(file_path), 
